  ...
  <v-container>
    <v-layout row wrap>
      <v-flex xs12>
        <page-header
          :title="'Experience'"
          :summary="'Some of my personal experiences as a developer'"></page-header>
      </v-flex>
      <v-flex
        xs12
        v-for="j in jobs"
        :key="j.company">
        <exp-card :job="j"></exp-card>
      </v-flex>
    </v-layout>
  </v-container>
</template>
    ...
    return {
      jobs: [
        ...
        },
        {
          ...
          tasks: [
            'Teaching Full Stack Development to students',
            'Topics: HTML, CSS, JavaScript, Node.js, React, MySQL, MongoDB, and light Java'
          ]
        }
      ]
    };
